 ...
 * Use the {@link profileLoggedIn#newInstance} factory method to
...
public class profileLoggedIn extends Fragment {
    ...
    public static profileLoggedIn newInstance(String param1, String param2) {
        profileLoggedIn fragment = new profileLoggedIn();
